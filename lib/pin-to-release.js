...
async function pinDut(release, dutUuid){
    ...
    await retry(
        async () => {
          ...
          console.log(`currently running: ${device.is_running__release.__id}, expecting ${releaseId}`)
...
module.exports = { pinDut, getLatestRelease}